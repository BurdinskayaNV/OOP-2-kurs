...
public class BotikWindowController {
    ...
    public  Message[] ArrayMessages = new Message[100];
    public  int CountMessages = 0;
    public TextField TextFieldMessage;
    public TextArea TextAreaMessages;

    public void onButtonSendMessage(ActionEvent actionEvent) {
    ...
    private String BotThink(String text, Date date, int countMessages) {
